...
exports.updatePassword = exports.resetPassword = exports.logout = exports.login = exports.signup = void 0;
...
var resetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(email, newPassword, passwordConfirm) {
    var res;
...
var updatePassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(email, newPassword, passwordConfirm, $form) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            //reload the same page
            if (res.data.status === 'success') {
              $form.append("<p>".concat(res.data.message, "</p>"));
            }
  ...
  return function updatePassword(_x10, _x11, _x12, _x13) {
...
var resetPasswordForm = document.querySelector('.form--reset-paswword');
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, _login.resetPassword)(email, password, passwordConfirm);
  });
}
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, _login.updatePassword)(email, password, passwordConfirm, updatePasswordForm);
  });
}
